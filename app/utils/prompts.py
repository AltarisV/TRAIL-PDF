PROMPTS = {
    'spanish': (
        "Tienes la tarea de ayudar a convertir materiales a formatos accesibles creando contenido accesible. "
        "Te estoy proporcionando una diapositiva de una conferencia universitaria. Genera una descripción que se pueda usar como texto alternativo para toda la diapositiva. "
        "Un estudiante con ceguera total debería poder entender la ilustración. Ignora los elementos decorativos en tu descripción. "
        "La accesibilidad es de suma importancia. Si reconoces asociaciones en la imagen, descríbelas. "
        "Si hay texto normal visible en la imagen, escribe el texto sin cambios, pero en español, incluyéndolo en el texto alternativo. "
        "Si el texto original no está en español, tu respuesta solo debe incluir el texto traducido al español."    
        "Si tu respuesta incluye una lista, la lista debe estar en html."
        "\n\n"
        "Si hay fórmulas matemáticas presentes, escribe una descripción precisa de esta fórmula en texto accesible, como si se leyera en voz alta. "
        "En lugar de '(' escribe 'paréntesis abierto,' y en lugar de ')' escribe 'paréntesis cerrado.' Si hay una fracción presente, debes nombrar el numerador "
        "y el denominador como tales ('numerador uno dividido por denominador dos es igual a 0.5'). Un ejemplo de una fórmula accesible es: "
        "\"Suma desde el índice 1 hasta n es igual a x punto y coma mu coma beta elevado a la potencia de menos 1 exponente final es igual a raíz cuadrada de numerador beta "  
        "dividido por denominador 2 pi resultado de la fracción raíz final exp paréntesis abierto menos uno medio fracción beta paréntesis izquierdo x menos mu paréntesis derecho "
        
        "al cuadrado paréntesis cerrado.\""
        "\n\n"
        "Si la imagen incluye una tabla, es tu tarea convertir esta tabla en código HTML, para que se convierta en una tabla HTML que un estudiante ciego pueda navegar "
        "accesiblemente con su lector de pantalla. Tu respuesta debe incluir código HTML para la tabla con <thead>, <tbody> y <th scope> tags, junto con un "
        "<caption> para la tabla. La respuesta no debe incluir markdown."
        "\n\n"  
        "Si la imagen contiene código, es tu tarea reproducir este código dentro de una etiqueta HTML <code>. Aquí hay un ejemplo si la imagen contiene código:\n"
        "<code>def hello_world():\n   print('hello world!')</code>"
        "\n\n"
        "En general, no escribas nada sobre el estilo, diseño o el logotipo de la institución. Esto es de suma importancia. "
        "Tu mensaje debe comenzar con 'Página {page_number}, {un título en una o dos palabras generado por ti}:' El título debe estar en español y ser elegido por ti. "
        "No repitas el título de la diapositiva en tu respuesta. No comiences tu respuesta con 'Texto alternativo:'."
    ),
    
    'italian': (
        "Il tuo compito è aiutare a convertire materiali in formati accessibili creando contenuti accessibili. "
        "Ti fornirò una diapositiva di una lezione universitaria. Genera una descrizione che possa essere utilizzata come testo alternativo per l'intera diapositiva. "
        "Uno studente cieco totale dovrebbe essere in grado di comprendere l’illustrazione. Ignora gli elementi decorativi nella tua descrizione. "
        "L’accessibilità è di fondamentale importanza. Se riconosci associazioni nell’immagine, descrivile. "
        "Se è visibile del testo, scrivilo senza modificarlo, ma in italiano, includendolo nel testo alternativo. "
        "Se il testo originale non è in italiano, la tua risposta deve includere solo la versione tradotta in italiano. "
        "Se la tua risposta include un elenco, deve essere in HTML."
        "\n\n"
        "Se ci sono formule matematiche, scrivi una descrizione precisa della formula in linguaggio accessibile, come se fosse letta ad alta voce. "
        "Al posto di '(' scrivi 'parentesi aperta' e al posto di ')' scrivi 'parentesi chiusa'. Se è presente una frazione, nomina numeratore "
        "e denominatore come tali ('numeratore uno diviso per denominatore due uguale 0,5'). Un esempio di formula accessibile è: "
        "\"Somma da indice 1 a n uguale x punto e virgola mu virgola beta elevato alla potenza di meno uno fine esponente uguale radice quadrata del numeratore beta "
        "diviso per denominatore 2 pi risultato della frazione fine radice exp parentesi aperta meno un mezzo frazione beta parentesi sinistra x meno mu parentesi destra "
        "al quadrato parentesi chiusa.\""
        "\n\n"
        "Se l’immagine contiene una tabella, è tuo compito convertirla in codice HTML, in modo che diventi una tabella accessibile navigabile da uno studente cieco con un lettore di schermo. "
        "La tua risposta deve includere codice HTML con tag <thead>, <tbody> e <th scope>, insieme a un <caption>. "
        "La risposta non deve contenere markdown."
        "\n\n"
        "Se l'immagine contiene codice, riproducilo all'interno del tag HTML <code>. Esempio:\n"
        "<code>def hello_world():\n   print('hello world!')</code>"
        "\n\n"
        "In generale, non scrivere nulla sullo stile, sul design o sul logo dell’istituzione. Questo è molto importante. "
        "Il tuo messaggio deve iniziare con 'Pagina {page_number}, {un titolo di una o due parole generato da te}:'. Il titolo deve essere in italiano e scelto da te. "
        "Non ripetere il titolo della diapositiva nella tua risposta. Non iniziare la tua risposta con 'Testo alternativo:'."
    ),
    'turkish': (
        "Erişilebilir içerik oluşturarak materyalleri erişilebilir formatlara dönüştürme konusunda yardımcı olmanız isteniyor. "
        "Size bir üniversite ders slaytı veriyorum. Bu slaytın tamamı için alternatif metin olarak kullanılabilecek bir açıklama oluşturun. "
        "Tamamen görme engelli bir öğrencinin görseli anlayabilmesi gerekir. Dekoratif unsurları açıklamanıza dahil etmeyin. "
        "Erişilebilirlik son derece önemlidir. Görselde ilişkilendirmeler fark ederseniz, bunları açıklayın. "
        "Görselde görünen normal metin varsa, metni olduğu gibi ama Türkçe olarak yazın ve alternatif metne dahil edin. "
        "Orijinal metin Türkçe değilse, yalnızca Türkçe çevirisini yazın. "
        "Yanıtınızda bir liste varsa, HTML kullanın."
        "\n\n"
        "Matematiksel formüller varsa, bu formülü yüksek sesle okunuyormuş gibi erişilebilir metinle açıklayın. "
        "'(' yerine 'parantez aç', ')' yerine 'parantez kapa' yazın. Bir kesir varsa, pay ve paydayı bu şekilde belirtin ('pay bir bölü payda iki eşittir 0,5'). "
        "Erişilebilir bir formül örneği: "
        "\"1’den n’e kadar toplam x noktalı virgül mu virgül beta üzeri eksi bir üst ifade sonu karekök içinde pay beta bölü payda 2 pi kesir sonucu kök sonu "
        "exp parantez aç eksi bir bölü iki kesir beta sol parantez x eksi mu sağ parantez karesi parantez kapa.\""
        "\n\n"
        "Görselde bir tablo varsa, bunu HTML koduna dönüştürmeniz gerekir. Böylece görme engelli bir öğrenci ekran okuyucusuyla erişebilir şekilde gezinebilir. "
        "Yanıtınızda <thead>, <tbody> ve <th scope> etiketleri ile birlikte bir <caption> etiketi içeren HTML tablosu olmalı. "
        "Yanıtınızda markdown olmamalı."
        "\n\n"
        "Görselde kod varsa, bu kodu HTML <code> etiketi içinde yeniden oluşturmanız gerekir. Örnek:\n"
        "<code>def hello_world():\n   print('hello world!')</code>"
        "\n\n"
        "Genel olarak, stil, tasarım veya kurum logosundan bahsetmeyin. Bu çok önemlidir. "
        "Mesajınız 'Sayfa {page_number}, {bir veya iki kelimelik, sizin oluşturduğunuz başlık}:' şeklinde başlamalıdır. Başlık Türkçe olmalı ve sizin tarafınızdan seçilmelidir. "
        "Slayt başlığını tekrar etmeyin. Yanıtınıza 'Alternatif metin:' ile başlamayın."
    ),
    'english': (
