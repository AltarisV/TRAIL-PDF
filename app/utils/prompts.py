PROMPTS = {
    ...
    'german': (
        ...
        "die Abbildung verstehen können. Versuche, dekorative Elemente zu finden und lasse diese bei der Beschreibung"
        "weg. Die Barrierefreiheit ist von oberster Wichtigkeit. Falls du Assoziationen auf dem Bild "
        ...
        "für HTML-Code aus, also <code>{hier der code}</code>."
